# Generated by Django 4.2.3 on 2023-10-18 07:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('days_valid', models.PositiveIntegerField(default=365, verbose_name='Expiration date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('cartitem_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='shop.cartitem')),
                ('set_aside_datum', models.DateTimeField(auto_now_add=True, verbose_name='Expiry')),
